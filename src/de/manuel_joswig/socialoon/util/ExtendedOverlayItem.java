...
public class ExtendedOverlayItem extends OverlayItem {
	...
	private boolean isBalloonOwner;
	
	public ExtendedOverlayItem(String aTitle, String aDescription,
			GeoPoint aGeoPoint, Balloon balloon, boolean isBalloonOwner, Context context) {
		...
		this.isBalloonOwner = isBalloonOwner;
	}
	...
	public boolean isBalloonOwner() {
		return isBalloonOwner;
	}
	...
	public void showBubble(InfoWindow bubble, MapView mapView, boolean panIntoView){
		...
		bubble.open(this, new GeoPoint(this.getPoint().getLatitude(), this.getPoint().getLongitude()), bubbleH.x, bubbleH.y);
		if (panIntoView)
